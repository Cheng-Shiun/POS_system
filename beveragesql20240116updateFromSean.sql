...
-- 正在傾印表格  beverage.javateaorder 的資料：~30 rows (近似值)
INSERT INTO `javateaorder` (`oNumber`, `type`, `product`, `material`, `qty`, `states`, `date`, `eDate`) VALUES
	...
	(27, '滋味茶', '粉粿黑糖檸檬', '蘆薈', 1, '熱飲', '2024-01-16 22:25:42', NULL),
	(28, '風味茶', '荔枝蘆薈', '琥珀粉圓', 2, '熱飲', '2024-01-16 22:25:57', NULL),
	(29, '風味茶', '荔枝蘆薈', '琥珀粉圓', 2, '熱飲', '2024-01-16 22:26:03', NULL),
	(30, '芝士奶蓋', '奶蓋烏龍茶', '蘆薈', 5, '冷飲', '2024-01-16 22:26:17', NULL),
	(31, '滋味茶', '粉粿黑糖檸檬', '草仔粿', 1, '熱飲', '2024-01-16 22:27:56', NULL);
