...
CREATE TABLE IF NOT EXISTS `franchise` (
  ...
  PRIMARY KEY (`fid`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='加盟專區使用之加盟基本資料';

-- 正在傾印表格  beverage.franchise 的資料：~9 rows (近似值)
INSERT INTO `franchise` (`fid`, `name`, `gender`, `phone`, `lineID`, `address`, `budget`, `opentime`, `contacttime`, `description`) VALUES
	(1, 'user01', NULL, '0913768302', '', '中清路一段89號5F-8', '10萬~100萬', '一個月', '早上09:00~12:00', ''),
	(2, 'user001', NULL, '0913768302', '', '中清路一段89號5F-8', '10萬~100萬', '一個月', '早上09:00~12:00', ''),
	(3, '陳怡婷', NULL, '0913768302', '', '學士路248巷35號', '10萬~100萬', '一個月', '早上09:00~12:00', ''),
	(4, 'user001', NULL, '123456789', '', '中清路一段89號5F-8', '100萬~200萬', '三個月', '下午12:00~18:00', ''),
	(5, '陳怡婷', NULL, '0913768333', '', '學士路248巷35號', '10萬~100萬', '一個月', '早上09:00~12:00', ''),
	(6, '陳怡', NULL, '123456789', '', '學士路248巷35號', '10萬~100萬', '一個月', '早上09:00~12:00', ''),
	(7, '楊小弟', NULL, '0912348658', '', '台中市', '10萬~100萬', '一個月', '早上09:00~12:00', ''),
	(8, '陳大哥', NULL, '0922876584', '', '台中市北區', '10萬~100萬', '一個月', '下午12:00~18:00', ''),
	(9, 'TSMC', '男', '0921888888', 'TSMC', 'TSMC', '10萬~100萬', '一個月', '早上09:00~12:00', '');
...
-- 正在傾印表格  beverage.javateaorder 的資料：~21 rows (近似值)
INSERT INTO `javateaorder` (`oNumber`, `type`, `product`, `material`, `qty`, `states`, `date`, `eDate`) VALUES
	...
	(15, '原味茶', '竹香翡翠', '草仔粿', 1, '冷飲', '2024-01-15 20:25:39', '2024-01-17 16:47:23'),
	(16, '原味茶', '竹香翡翠', '草仔粿', 1, '冷飲', '2024-01-15 21:20:17', '2024-01-17 16:47:22'),
	(17, '風味茶', '荔枝蘆薈', '雙粉(粉粿+粉圓)', 3, '熱飲', '2024-01-15 21:40:53', '2024-01-17 16:47:22'),
	(18, '原味茶', '竹香翡翠', '草仔粿', 1, '冷飲', '2024-01-15 22:49:16', '2024-01-17 16:47:20'),
	(19, '原味茶', '竹香翡翠', '琥珀粉圓', 2, '冷飲', '2024-01-16 07:53:26', '2024-01-17 16:46:36'),
	(20, '風味茶', '鮮葡萄柚青茶', '琥珀粉圓', 3, '冷飲', '2024-01-18 09:54:53', '2024-01-18 09:55:00'),
	(21, '原味茶', '招牌紅茶', '草仔粿', 1, '冷飲', '2024-01-24 02:39:06', NULL);
...
INSERT INTO `member` (`mid`, `memberName`, `memberPhone`, `memberAddress`, `birthday`, `gender`, `email`, `name`, `phone`) VALUES
	(1, 'Sean', '0921324600', '台中市北區漢口路一段100號', '2003-01-06', '男', 'sean@gmail.com', NULL, NULL),
	(2, 'Joy', '0921730887', '台中市北區漢口路二段200號', '1983-12-09', '女', 'joy@gmail.com', NULL, NULL),
	(3, 'Justin', '0921748596', '台中市大雅區神林路一段100號', '1983-01-06', '男', 'justin@gmail.com', NULL, NULL),
	(6, 'Wayne', '0921748596', '台中市大雅區神林路二段200號', '1983-01-02', '男', 'wayne@gmail.com', NULL, NULL),
	(7, 'Ben', '0921968574', '台中市大雅區神林路三段300號', '1979-01-03', '男', 'ben@yahoo.com', NULL, NULL),
	(8, 'Alex', '0921968574', '台中市西屯區中港路一段100號', '1982-01-03', '男', 'alex@yahoo.com', NULL, NULL),
	(9, 'Bob', '0921748596', '台中市西屯區中港路一段100號', '1979-02-02', '男', 'bob@yahoo.com', NULL, NULL),
	(10, 'Molly', '0921748596', '台中市西屯區中港路二段200號', '1979-02-02', '女', 'molly@yahoo.com', NULL, NULL),
	(11, 'James', '0921748596', '台中市大雅區神林路二段200號', '1977-02-28', '男', 'james@gmail.com', NULL, NULL),
	(12, 'Joyce', '0921748596', '台中市西屯區中港路二段200號', '1983-07-19', '女', 'joyce@outlook.com', NULL, NULL),
	(13, 'Kama', '0921876549', '台中市神岡區圳前路一段100號', '2011-11-11', '女', 'Kama@gmail.com', NULL, NULL),
	(14, 'Cook', '0921748596', '台中市北區陝西路一段100號', '1979-01-01', '男', 'cook@gmail.com', NULL, NULL),
	(15, 'Rod', '0921324600', '台中市神岡區神林路一段100號', '1979-02-13', '男', 'rod@gmail.com', NULL, NULL),
	(16, 'Java', '0921748596', '台中市北區中清路一段100號', '1979-07-07', '男', 'java@gmail.com', NULL, NULL);
